...
function pilihan1($kode_unik)
{
    global $conn;
    $query = "UPDATE data_siswa SET status='Diterima' WHERE kode_unik=$kode_unik";
    // $query1 = "UPDATE jurusan_dituju set jurusan_1='$jurusan_1' where kode_unik=$kode_unik";
    // $conn->exec($query);
