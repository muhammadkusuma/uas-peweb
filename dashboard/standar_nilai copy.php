            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <?php while ($d = $data->fetch(PDO::FETCH_ASSOC)) : ?>
                        ...
                        $rata = $nilai;
                        if ($rata > 50 & $rata < 100) {
                            $data = $conn->prepare("UPDATE jurusan_dituju,riwayat_pendidikan set jurusan_dituju.jurusan_1='s111', jurusan_dituju.jurusan_2='' where riwayat_pendidikan.kode_unik=jurusan_dituju.kode_unik");
                            $data->execute();
                        }
                        // if ($nilai >= 50) {
                        //     $jurusan_1 = "TKJ";
